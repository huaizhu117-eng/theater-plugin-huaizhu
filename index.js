// 槐序戏台 - 第四十四版：①"新建收藏"/"新建随机生成"不再各自弹出一个独立的浮动框叠在主面板上面——之前是两个框各自定位、容易看起来像叠在一起，现在改成在同一个面板内部切换"列表视图"和"编辑视图"，点新建/编辑就是同一个框内容变了，不会再有第二个框冒出来；切换到别的标签或重新打开仓库/随机生成标签时，会自动切回列表视图，不会卡在编辑表单上；②随机生成的分组分隔符从"逗号/、//"四种混用简化成只用"/"（半角全角都认），分组输入框的提示文字也大幅缩短，不会再显得又长又挤
    ...
    <div id="huaizhu_modal_overlay" class="huaizhu-modal-overlay" style="display:none;">
      <div class="huaizhu-modal-box">
        ...
        <div class="huaizhu-meta-row">
          <span class="huaizhu-meta-text">版本：0.4.4</span>
        ...
        <div id="huaizhu_tab_template" class="huaizhu-tab-page" style="display:none;">
          ...
          <div id="huaizhu_template_edit_view" style="display:none;">
            <div class="huaizhu-panel-header">
              <h3 id="huaizhu_template_edit_title">新建随机生成</h3>
